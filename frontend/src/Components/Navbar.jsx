        ...
        <Box px={4} mb={20} className='ChackraNavBar' shadow='lg' borderBottom={{base : '0px', md :'1px solid black'}} padding='10px'>
          <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
            ...
            <Flex width={{base : "20%", md :'13%', lg : '10%'}} justifyContent={'center'} >
             <Link to='/'><Image src='https://s3.us-east-1.amazonaws.com/cdn.designcrowd.com/blog/108-fashion-logos-to-show-off-your-style/retro-men-fashion-by-shen02-brandcrowd.png' width='100px' m='auto'/></Link>
            </Flex>
