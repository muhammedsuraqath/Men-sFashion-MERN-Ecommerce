            ...
            <SimpleGrid columns={[2,2,3,3]}  width={{base :'95%', md :'90%', lg :'80%'}} m='auto' padding='20px' rowGap='30px'>
                ...
                <Box width={{base :'90%'}}>
                    ...
                    <List cursor='pointer' lineHeight='35px'> 
                        <ListItem>MEN,S FASION - AU</ListItem>
                        <ListItem>MEN,S FASION - CA</ListItem>
                        <ListItem>MEN,S FASION - UK</ListItem>
                        <ListItem>MEN,S FASION - India</ListItem>
                        <ListItem>MEN,S FASION - Osterreich</ListItem>
                        <ListItem>MEN,S FASION - Schweiz</ListItem>
                        <ListItem>MEN,S FASION - Espana</ListItem>
                        <ListItem>MEN,S FASION - France</ListItem>
                        <ListItem>MEN,S FASION - Italia</ListItem>
                        <ListItem>MEN,S FASION - Belgie</ListItem>
                        <ListItem>MEN,S FASION - Nederland</ListItem>
                    </List>
                </Box>
